...
from envs.WordChains.renderer import create_board_str
from learnarena_utils.word_lists import EnglishDictionary


class WordChainsEnv(Env):
    ...
    def reset(self, num_players: int, seed: Optional[int]=None):
        ...
        self.state = State(num_players=2, min_players=2, max_players=2)
